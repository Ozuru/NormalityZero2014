 ...
 * directory.
 */
public class Mechatron extends IterativeRobot {

    public static DriveTrain _driveTrain;
    public static Pneumatics _pneu;
    public static Winch _winch;
    public static OI oi;
    ...
    public void robotInit() {
        ...
        _pneu = new Pneumatics();
        _winch = new Winch();
        oi = new OI();
        autonomousCommand = null;
        Compressor compressor = new Compressor(RobotMap.PORT_COMPRESSOR_1, RobotMap.PORT_COMPRESSOR_2);
        compressor.start();
        // Initialize all subsystems
        _driveTrain.invertMotors();
        CommandBase.init();
    }
